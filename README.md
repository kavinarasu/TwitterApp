...
This time, the tutorial covered only the concept and it was interesting to implement the project on own and to integrate with the existing project in Objective-C. I didn't have much time last week to complete the optionals
